...
void main() {
	testWidgets('FooterWidget displays all main sections', (WidgetTester tester) async {
	...
	testWidgets('FooterWidget search link triggers callback', (WidgetTester tester) async {
		bool tapped = false;
		await tester.pumpWidget(
			MaterialApp(
				home: Scaffold(
					body: FooterWidget(onSearchTap: () { tapped = true; }),
				),
			),
		);
	...
	testWidgets('FooterWidget email field and subscribe button are present', (WidgetTester tester) async {
		await tester.pumpWidget(
			MaterialApp(
				home: Scaffold(
					body: FooterWidget(),
